...
// Colors.
export const colors = {
  color1: '#00dcb9', // Primary.
  color2: '#00dcb9', // Secondary.
  color3: '#00dcb9', // Text primary.
  color4: '#00dcb9', // Text secondary.
  color5: '#00dcb9', // Background.
  color6: '#00dcb9' // White background.
}

// Fonts.
export const fonts = {
  font1: "'Nova Mono', sans-serif;", // Primary.
