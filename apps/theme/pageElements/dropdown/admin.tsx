  ...
  // The `PbEditorPageElementPlugin` plugin.
  {
    ...
    toolbar: {
      ...
      preview() {
        ...
        return <>dropdown Chart Page Element</>
      }
    },
            ...
            <Cell span={12}>
              ...
              {dataViews.length ? (
                <Bind name={'variables.source'}>
                  <Select label={'Data Source'} description={'Data source to show in the dropdown'}>
              ...
              <>
                ...
                <Cell span={12}>
                  <Bind name={'variables.defaultOption'}>
                    <Select label={'Default Option'} description={'Default option to show'}>
