...
const INITIAL_ELEMENT_DATA: BarProps = {
  variables: {
    source: '',
    x: '',
    y: '',
...
export default [
  ...
  {
    name: 'pb-editor-page-element-bar',
  ...
  {
    name: 'pb-editor-page-element-advanced-settings-bar',
        ...
        <>
          <Grid>
              ...
              <>
                ...
                <Cell span={12}>
                  ...
                  <Bind name={'variables.direction'}>
                    <Select
                      label={'Direction of the bar chart'}
                      description={'Horizontal or vertical, by default vertical'}
                    >
            ...
            <Cell span={12}>
              <p>Code Snippets</p>
              <p>
                <i>Copy and paste this code snippet into your page to display the bar.</i>
              </p>
              <pre
                style={{
                  maxWidth: '100%',
